...
if __name__=="__main__":
    ...
    parser.add_argument("--obj_img", type=str, default="/home/aikusrv01/sims/hyunwook/CustomNet/examples/mugcup.jpg")
    parser.add_argument("--bg_img", type=str, default="/home/aikusrv01/sims/hyunwook/CustomNet/examples/background2.jpg")
    parser.add_argument("--bbox", type=str, default='100,100,200,200')
